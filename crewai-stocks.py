...
stockPriceAnalyst = Agent(
    ...
    backstory='''You're highly experiencied in analyzing the price of an specefic stock and make predictions about its future price
    ''',
    verbose=True,
    llm=llm,
    max_iter=5,
...
#IMPORTANT A TOOL OF SEARCH
search_tool = DuckDuckGoSearchResults(backend='news', num_results=10)


newsAnalyst = Agent(
    role='Stock News Analyst',
    goal='Create a short summer of the market news related to the stock {ticket} company. Specify the current trend - up, down or sideways with the news context. For each request stock specify a number between 0 and 100, where 0 is extreme fear and 100 extreme greed',
    backstory='''You're highly experiencied in analyzing the market trends and news and have tracked assest for more then 10 years.
...
get_news = Task(
    ...
    expected_output="""A sumnary of the overall market and one sentence summary for each request asset.
